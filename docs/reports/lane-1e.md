...
| `6006d46` | feat: add BUILD studio shell with XYFlow canvas |
| `99f975c` | docs: add lane 1e studio BUILD report |
...
- Persistence deferred to lane 1d; IR lives in React store state.
